...
source("species_explorer_server.R")
...
server <- function(input, output, session){
  ...
  speciesExplorerServer(input, output, session, dm_data, taxo, meow_eco)
  
  proxy <- dataTableProxy("speciesTaxoTable")
